                ...
                <div className="container mx-auto px-6">
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                        ...
                        <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all">
                            ...
                            <p className="text-gray-600 mb-4">
                                A dedicated companion for your pregnancy journey, offering weekly
                                updates, health tips, and milestone tracking.
                            </p>
                            <ul className="space-y-2 text-sm text-gray-500">
                                <li className="flex items-center gap-2">
                                    <span className="w-1.5 h-1.5 bg-primary rounded-full"></span>
                        ...
                        <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all">
                            ...
                            <p className="text-gray-600 mb-4">
                                Specialized tools for Malaria prevention, symptom monitoring, and
                                recovery tracking to ensure complete health.
                            </p>
                            <ul className="space-y-2 text-sm text-gray-500">
                                <li className="flex items-center gap-2">
                                    <span className="w-1.5 h-1.5 bg-primary rounded-full"></span>
                        ...
                        <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all">
                            ...
                            <p className="text-gray-600 mb-4">
                                Personalized plans to manage joint pain, including exercises, diet
                                recommendations, and pain logging.
                            </p>
                            <ul className="space-y-2 text-sm text-gray-500">
                                <li className="flex items-center gap-2">
                                    <span className="w-1.5 h-1.5 bg-primary rounded-full"></span>
                        ...
                        <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all">
                            ...
                            <p className="text-gray-600 mb-4">
                                Get digital prescriptions sent directly to your preferred pharmacy
