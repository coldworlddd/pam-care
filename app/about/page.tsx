            ...
            <section className="bg-primary/5 py-20">
                <div className="container mx-auto px-6 text-center">
                    ...
                    <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                        Revolutionizing healthcare with intelligent AI assistance for Malaria,
                        Pregnancy, and Arthritis care.
                    </p>
                </div>
            </section>
                ...
                <div className="container mx-auto px-6">
                    <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
                        <div className="space-y-6">
                            ...
                            <p className="text-lg text-gray-600 leading-relaxed">
                                ...
                                accessible to everyone, everywhere. Our mission is to leverage the
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        <div className="p-8 border border-gray-100 rounded-2xl hover:shadow-lg transition-shadow">
                            ...
                            <p className="text-gray-600">
                                Early detection tools, symptom tracking, and immediate guidance on
                                treatment protocols for Malaria management.
                            </p>
                        </div>
