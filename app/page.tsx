            ...
            <div className="bg-[#F3F4F6] p-8 rounded-3xl hover:bg-white hover:shadow-xl transition-all duration-300 group">
              <div className="w-14 h-14 bg-[#E5E7EB] rounded-2xl flex items-center justify-center mb-6 group-hover:bg-primary/10 transition-colors">
                ...
                >
                  <rect width="76" height="76" rx="12" fill="#E5E7EB" />
                  <path
                    d="M44.6666 55.9168H22.9999C21.3999 55.9168 20.0833 54.6002 20.0833 53.0002V31.3335C20.0833 23.9668 23.9666 20.0835 31.3333 20.0835H44.6666C52.0333 20.0835 55.9166 23.9668 55.9166 31.3335V44.6668C55.9166 52.0335 52.0333 55.9168 44.6666 55.9168ZM31.3333 22.5835C25.3666 22.5835 22.5833 25.3668 22.5833 31.3335V53.0002C22.5833 53.2335 22.7666 53.4168 22.9999 53.4168H44.6666C50.6333 53.4168 53.4166 50.6335 53.4166 44.6668V31.3335C53.4166 25.3668 50.6333 22.5835 44.6666 22.5835H31.3333Z"
                    fill="#292D32"
                  />
                  <path
                    d="M46.3334 35.0835H29.6667C28.9834 35.0835 28.4167 34.5168 28.4167 33.8335C28.4167 33.1502 28.9834 32.5835 29.6667 32.5835H46.3334C47.0167 32.5835 47.5834 33.1502 47.5834 33.8335C47.5834 34.5168 47.0167 35.0835 46.3334 35.0835Z"
                    fill="#292D32"
                  />
                  <path
                    d="M41.3334 43.4165H29.6667C28.9834 43.4165 28.4167 42.8498 28.4167 42.1665C28.4167 41.4832 28.9834 40.9165 29.6667 40.9165H41.3334C42.0167 40.9165 42.5834 41.4832 42.5834 42.1665C42.5834 42.8498 42.0167 43.4165 41.3334 43.4165Z"
                    fill="#292D32"
                  />
                </svg>
              </div>
