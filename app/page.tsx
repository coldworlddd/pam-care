      ...
      <header className="sticky top-0 z-50 bg-white border-b border-gray-100">
        <nav className="container mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <h1 className="text-2xl font-bold text-purple-700">Docta</h1>
            <span className="text-sm text-gray-500">Medical Care</span>
          </div>
          <div className="hidden md:flex items-center gap-8">
            <a href="#how-it-works" className="text-gray-600 hover:text-purple-700">How It Works</a>
            <a href="#services" className="text-gray-600 hover:text-red-500">Our Service</a>
            <a href="#pricing" className="text-gray-600 hover:text-purple-700">Pricing & Insurance</a>
            <a href="#inside" className="text-gray-600 hover:text-purple-700">Inside Docta</a>
            <a href="#reviews" className="text-gray-600 hover:text-purple-700">Reviews</a>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="flex gap-8">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-700 font-medium">5 Million Downloaded</span>
              </div>
              <div className="flex items-center gap-2">
                <svg className="w-5 h-5 text-green-500" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                </svg>
                <span className="text-gray-700 font-medium">4.8 (90k) Client Review</span>
              </div>
            </div>
          </div>
              ...
              <div className="relative bg-black rounded-[2.5rem] p-2 shadow-2xl">
                <div className="bg-white rounded-[2rem] h-full overflow-hidden">
                  ...
                  <div className="p-4 space-y-4">
                    ...
                    <p className="text-sm text-gray-600">anytime, anywhere via video call</p>
                    
                    {/* Chat messages */}
                    <div className="space-y-3 mt-6">
                      <div className="bg-gray-100 rounded-lg p-3">
                        <p className="text-sm">Hello I'm suffering from fever since 3 days.</p>
                      </div>
                      <div className="bg-purple-100 rounded-lg p-3 ml-4">
                        <p className="text-sm">Okay, no worries we will know how you get now?</p>
                      </div>
                    </div>
        ...
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="lg:order-2 space-y-8">
              <p className="text-sm text-gray-500 uppercase tracking-wide">Why simple is better</p>
              <h2 className="text-4xl lg:text-5xl font-bold text-purple-900">Smart and affordable.</h2>
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Skip the trip and start your visit any time with any device.</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="flex-shrink-0 w-12 h-12 bg-purple-100 rounded-full flex items-center justify-center">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg mb-1">A price that doesn't hurt</h3>
                    <p className="text-gray-600">Your visit is $39 - and even less with insurance.</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="flex-shrink-0 w-12 h-12 bg-purple-100 rounded-full flex items-center justify-center">
                  ...
                  <div>
                    <h3 className="font-semibold text-lg mb-1">Prescriptions & treatment plans</h3>
                    <p className="text-gray-600">You'll get a customized treatment plan, plus.</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section id="how-it-works" className="py-20">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 mt-2">Your 24/7 online clinic</p>
          </div>
          ...
          <div className="space-y-20">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-4">
                <h3 className="text-2xl font-bold text-purple-900">Answer a few questions</h3>
                <p className="text-gray-600 text-lg">
                  We gather your basic health information to help us understand your condition better and connect you with the right doctor.
                </p>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-4 lg:order-2">
                <h3 className="text-2xl font-bold text-purple-900">Diagnosis by real people, really fast</h3>
                <p className="text-gray-600 text-lg">
                  Our board-certified doctors will review your information, provide a diagnosis, and create a personalized treatment plan. You can chat with them directly.
                </p>
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <p className="text-sm text-gray-700 mb-2">Medical information and diagnosis details...</p>
                  <button className="text-purple-700 font-medium text-sm">View more →</button>
                </div>
              </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-4">
                <h3 className="text-2xl font-bold text-purple-900">Payment & Insurance</h3>
                <p className="text-gray-600 text-lg">
                  We accept most major insurance plans and offer transparent pricing for self-pay patients. Your payment information is secure.
                </p>
                <div className="bg-white border border-gray-200 rounded-lg p-4 space-y-3">
                  <div>
                    <label className="text-sm text-gray-600">Card number</label>
                    <input type="text" className="w-full mt-1 px-3 py-2 border border-gray-200 rounded" placeholder="1234 5678 9012 3456" />
                  </div>
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <label className="text-sm text-gray-600">Expiry date</label>
                      <input type="text" className="w-full mt-1 px-3 py-2 border border-gray-200 rounded" placeholder="MM/YY" />
                    </div>
                    <div>
                      <label className="text-sm text-gray-600">CVV</label>
                      <input type="text" className="w-full mt-1 px-3 py-2 border border-gray-200 rounded" placeholder="123" />
                    </div>
                  </div>
                  <div className="border-t border-gray-200 pt-3 flex justify-between items-center">
                    <span className="font-semibold">Total</span>
                    <span className="text-2xl font-bold text-purple-700">$39</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-4 lg:order-2">
                <h3 className="text-2xl font-bold text-purple-900">Start feeling better</h3>
                <p className="text-gray-600 text-lg">
                  Once your treatment plan is in place, you can start feeling better. We'll follow up with you to ensure your recovery is on track.
                </p>
                <div className="bg-white border border-gray-200 rounded-lg p-4 space-y-3">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-gray-700">Drink plenty of fluids</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <div className="w-5 h-5 border-2 border-purple-700 rounded flex items-center justify-center">
                      <svg className="w-3 h-3 text-purple-700" fill="currentColor" viewBox="0 0 20 20">
      ...
      <section className="bg-gray-50 py-20">
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            {/* Right Column - Text */}
            <div className="space-y-8">
              <p className="text-sm text-gray-500 uppercase tracking-wide">Quality by design</p>
              <h2 className="text-4xl lg:text-5xl font-bold text-purple-900">Safe and secure.</h2>
              <p className="text-gray-600 text-lg leading-relaxed">
                We use the latest security protocols to ensure your personal and medical information is always safe. Our platform is HIPAA compliant and GDPR ready.
              </p>
      ...
      <section className="py-20">
        <div className="container mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            {/* Left Column - Text */}
            <div className="space-y-8">
              <p className="text-sm text-gray-500 uppercase tracking-wide">Why wait & help</p>
              <h2 className="text-4xl lg:text-5xl font-bold text-purple-900">Ready to give us a try?</h2>
              <p className="text-gray-600 text-lg leading-relaxed">
                Join thousands of satisfied patients who have experienced convenient, affordable, and high-quality online healthcare.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <button className="flex items-center justify-center gap-2 bg-purple-700 text-white px-6 py-3 rounded-full hover:bg-purple-800 transition-colors">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                ...
                <li><a href="#services" className="hover:text-purple-700">Our Service</a></li>
                <li><a href="#pricing" className="hover:text-purple-700">Pricing & Insurance</a></li>
                <li><a href="#faq" className="hover:text-purple-700">FAQ</a></li>
              </ul>
            </div>
            <div>
              <h4 className="font-semibold text-gray-900 mb-4">Resources</h4>
              <ul className="space-y-2 text-sm text-gray-600">
                <li><a href="#careers" className="hover:text-purple-700">Careers</a></li>
                <li><a href="#blog" className="hover:text-purple-700">Blog</a></li>
                <li><a href="#support" className="hover:text-purple-700">Help & Support</a></li>
                <li><a href="#terms" className="hover:text-purple-700">Terms</a></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-600">
                ...
                <li><a href="#privacy" className="hover:text-purple-700">Privacy Policy</a></li>
              </ul>
            </div>
          </div>
